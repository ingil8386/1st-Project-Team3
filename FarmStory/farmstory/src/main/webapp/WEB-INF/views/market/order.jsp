        ...
        <div id="sub">
            ...
            <section class="market">
                ...
                <article class="order">
                    ...
                    <div class="final">                        
                        <table border="0" class="final-table">
                    ...
                    <div class="shipping">
                        <table border="0">
                            <tbody>
                                <tr>
                                    <th>주문자</th>
                                    <td><input type="text" name="orderer" value="홍길동" readonly class="chk-input"></td>
                                </tr>
                                <tr>
                                    <th>휴대폰</th>
                                    <td><input type="text" name="orderer" value="010-1234-1001" readonly class="chk-input"></td>
                                </tr>
                                <tr>
                                    <th>포인트사용</th>
                                    <td class="point-td">
                                        <input type="text" name="pointUse" value="" class="short-input">
                                ...
                                <tr>
                                    <th>받는분</th>
                                    <td><input type="text" name="receiver" class="normal-input"></td>
                                </tr>
                                <tr>
                                    <th>연락처</th>
                                ...
                                <tr>
                                    ...
                                    <td class="addr-td">
                                        <div class="addr-row">
                                            ...
                                            <button type="button" id="btnZip" class="btnInside">우편번호 검색</button>
                                        </div>
                                        <input type="text" name="addr1" placeholder="기본주소 검색" class="long-input">
                                        <input type="text" name="addr2" placeholder="상세주소 입력" class="long-input">
                                    </td>
                                </tr>
                                <tr>
                                    <th>결제방법</th>
                                ...
                                <tr>
                                    <th>기타</th>
                                    <td>
                                        <textarea name="etc" class="etc-textarea"></textarea>
                                    </td>
                                </tr>
                            </tbody>
                        </table>

...
<div id="sub">
    ...
    <section class="croptalk">
        ...
        <article id="board">
            ...
            <section class="write">
                <form action="<%= request.getContextPath() %>/story/write.do" method="post">
                    ...
                    <div class="btnGroup">
                        <a href="<%= listUrl %>" class="btn btnCancel">취소</a>

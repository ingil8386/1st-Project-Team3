    ...
    <section class="croptalk">
        <aside>
            ...
            <ul class="lnb">
                ...
                <li class="on"><a href="<%= request.getContextPath() %>/story/garden.do">텃밭가꾸기</a></li>
        ...
        <article id="board">
            ...
            <section class="list">
                <nav>
                    ...
                    <form action="<%= request.getContextPath() %>/story/garden.do" method="get">
                ...
                <a href="<%= request.getContextPath() %>/story/write.do?boardno=2" class="btn btnWrite">글쓰기</a>
            </section>
        </article>
    </section>
</div>

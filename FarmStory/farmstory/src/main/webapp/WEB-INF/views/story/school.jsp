    ...
    <section class="croptalk">
        <aside>
            ...
            <ul class="lnb">
                ...
                <li class="on"><a href="<%= request.getContextPath() %>/story/school.do">귀농학교</a></li>
            </ul>
        </aside>
        ...
        <article id="board">
            ...
            <section class="list">
                <nav>
                    ...
                    <form action="<%= request.getContextPath() %>/story/school.do" method="get">
                ...
                <a href="<%= request.getContextPath() %>/story/write.do?boardno=3" class="btn btnWrite">글쓰기</a>
            </section>
        </article>
    </section>
</div>

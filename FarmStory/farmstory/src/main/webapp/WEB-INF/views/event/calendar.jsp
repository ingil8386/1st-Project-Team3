...
<div id="sub">
	<div>
		<img src="<%= request.getContextPath() %>/images/sub_top_tit4.png"
			alt="CROP TALK">
	</div>
	...
	<section class="event">
		<aside>
			<img
				src="<%= request.getContextPath() %>/images/sub_aside_cate4_tit.png"
				alt="이벤트" />

			<ul class="lnb">
				<li class="on"><a
					href="<%= request.getContextPath() %>/event/calendar.do">이벤트</a></li>
			</ul>
		...
		<article id="board">
			<nav>
				<img
					src="<%= request.getContextPath() %>/images/sub_nav_tit_cate4_tit1.png"
					alt="이벤트" />
				<p>
					HOME > 이벤트 > <em>이벤트</em>
				</p>

		...
		<main>
			<div class="main_inner">
				...
				<section class="content">
					...
					<form
						action="<%= request.getContextPath() %>/admin/product/product_register.do"
						...
						<table class="register_table">
							...
							<tr>
								<th>종류</th>
								<td><select name="productcate" required>
							...
							<tr>
								<th>가격</th>
								<td><input type="text" name="productprice" required>
								</td>
							</tr>

							<tr>
								<th>할인</th>
								<td><select name="productdiscount">
							...
							<tr>
								<th>포인트</th>
								<td><input type="text" name="productpoint" value="0">
									<span class="desc">포인트 입력</span></td>
							</tr>

							<tr>
								<th>재고</th>
								<td><input type="text" name="productstock" required>
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<div class="file_row">
										<span>상품 이미지</span> <input type="file" name="thumb120"
											accept="image/*">
									</div>
								</td>
							</tr>

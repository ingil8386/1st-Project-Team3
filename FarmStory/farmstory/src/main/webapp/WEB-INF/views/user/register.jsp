            ...
            <section class="register">
                <form action="/farmstory/user/register.do" method="post">
                    ...
                    <table border="1">
                        ...
                        <tr>
                            <td>비밀번호</td>
                            <td><input type="password" name="memberpass" placeholder="비밀번호 입력"/>
					...
					<div style="display: flex; justify-content: flex-end; gap: 10px; margin-top: 20px;">
					    ...
					    <a href="/farmstory/user/login.do" class="btn btnCancel" style="
					        display: block; 
					        box-sizing: border-box; 
					        width: 100px; 
					        height: 35px; 
					        line-height: 33px; /* 높이에서 위아래 테두리 2px를 뺀 값으로 세로 중앙 정렬 */
					        text-align: center; 
					    ...
					    <input type="submit" value="회원가입" class="btn btnRegister" style="
					        display: block; 
					        box-sizing: border-box; 
					        width: 100px; 
					        height: 35px; 
